    ...
    <footer className={styles.container} style={{ paddingBottom: "2rem" }}>
      <section style={{ display: "flex", flexWrap: "wrap", margin: "2rem 0", justifyContent: "space-around", alignItems: "center"}}>
        <div style={{
          ...
          maxWidth: isTablet ? "100%" : "20%",
          width: "100%",
          gap: "1rem",
          marginBottom: isTablet ? "1rem" : "0"
        }}>
          <img src={logo} alt="logo" style={{ width:  isTablet ? "3rem" : "6rem" }} />
          <p>
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: isTablet ? "100%" : "30%", width: "100%", marginBottom: isTablet ? "1rem" : "0"}}>
          <div className={styles.list}>
            <p style={{ fontSize: "1.2rem" }}>Site Map</p>
            <Link to="/reviews" className={styles.link}>Reviews</Link>
            <Link to="/documentation" className={styles.link}>API Documentation</Link>
            <Link to="/beans" className={styles.link}>Beans</Link>
            <Link to="/facts" className={styles.link}>Facts</Link>
            <Link to="/recipes" className={styles.link}>Recipes</Link>
            <Link to="/combinations" className={styles.link}>Combinations</Link>
            <Link to="/history" className={styles.link}>History</Link>
          </div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", maxWidth: isTablet ? "100%" : "20%", }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: isTablet ? "100%" : "30%", alignItems: "center" }}>
      ...
      <p style={{ fontSize: ".75rem", margin: "0 1rem" }}>Copyright © 2023 All Rights Reserved, Object-ions</p>
    </footer>
  );
};
